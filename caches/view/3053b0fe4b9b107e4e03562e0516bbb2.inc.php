...
<?php
	...
	$data = $taglib_ads_ads->lists(array('position'=>'1','order'=>'rand()'), array('limit'=>'1','cache'=>'bf7a925be52c76ed5ad50c9295e46ec9,3600'));
?>
<?php if(($data['list'])){?>
...
<div class="logo fl">
<span><a href="<?php echo __APP__;?>"><img width="190px" height="64px" src="<?php $cache = model('admin/setting','service')->get(); echo $cache['site_logo'] ? $cache['site_logo'] : 'template/default/statics/images/logo.png' ?>" /></a></span>
</div>
<!-- 搜索框 -->
...
<?php
	...
	$data = $taglib_goods_search->lists(array(), array('limit'=>'8','cache'=>'d5a8dd1cea5479baed7141b0455aa15d,3600'));
...
<?php
	...
	$data = $taglib_goods_goods->history(array(), array('limit'=>'5','cache'=>'20161ccf76c576052da0e6d9e3d5ea09,3600'));
...
<?php
	...
	$data = $taglib_goods_category->lists(array('order'=>'sort asc','catid'=>'0'), array('limit'=>'20','cache'=>'2eacf4aa8944d567fced9b42e74e7475,3600'));
...
<?php
	$taglib_goods_category = new taglib('goods','category');
	$data = $taglib_goods_category->lists(array('order'=>'sort asc','catid'=>$r[id],'type'=>'nav'), array('limit'=>'20','cache'=>'2165894dae8c52f151f7982907e9e0a2,3600'));
...
<?php
	$taglib_goods_category = new taglib('goods','category');
	$data = $taglib_goods_category->lists(array('order'=>'sort asc','catid'=>$r[id]), array('limit'=>'20','cache'=>'58ff29b493dc738ce43d70d5da8204c0,3600'));
...
<?php
	...
	$data = $taglib_misc_navigation->lists(array('order'=>'sort ASC'), array('limit'=>'20','cache'=>'72f745fcc19566e851c5982e7bb38ca3,3600'));
