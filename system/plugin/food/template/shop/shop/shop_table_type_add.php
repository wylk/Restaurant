    ...
    <script type="text/javascript">
        $(function () {
            $('#add').click(function(){
              ...
              console.log(data);
             $.post('./index.php?m=plugin&p=shop&cn=index&id=food:sit:do_shop_table_type_add',data,function(re){
                console.log(re);
                if (re.error == 0) {
                    swal({
                     title: "友情提示！",
                         ...
                         type: "success"
                            ...
                            window.location.href='?m=plugin&p=shop&cn=index&id=food:sit:do_shop_table_type'
                         });
                }else{
