                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-9">
                        ...
                        <div class="help-block">
                            还没有分类，点我 <a href="?m=plugin&p=shop&cn=index&id=food:sit:do_shop_table_type_add"><i class="fa fa-plus-circle"></i> 添加分类</a>
                        </div>
                    </div>
                </div>
                <div class="form-group">
                    ...
                    <div class="col-sm-9">
                        <select class="form-control" style="margin-right:15px;" name="table_label_id" autocomplete="off" class="form-control">
                            ...
                            <?php foreach ($printlabel as $key => $value) {?>
                            <option value="<?php echo $value['id'] ?>" ><?php echo $value['title']?></option>
                            <?php } ?>
                            </select>
                        <div class="help-block">
                            还没有标签，点我 <a href="?m=plugin&p=shop&cn=index&id=food:sit:do_shop_table_printlabel_add"><i class="fa fa-plus-circle"></i> 添加标签</a>
                        </div>
                    </div>
                </div>
                <div class="form-group">
    ...
    <script type="text/javascript">
        $(function () {
            $('#add').click(function(){
              ...
              var tablezonesid = $('input[name="tablezonesid"]').val();
              var table_label_id = $('input[name="table_label_id"]').val();
              ...
              console.log(data);
             $.post('./index.php?m=plugin&p=shop&cn=index&id=food:sit:do_shop_table_add',data,function(re){
                console.log(re);
                if (re.error == 0) {
                    swal({
                     title: "友情提示！",
